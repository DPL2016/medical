              ...
              <a href="/account"> 系统账户列表</a>  /  修改账号
                ...
                <div class="box-body form">
                    <form id="editForm">
                        ...
                        <label>员工姓名</label>
                        <input type="text" id="name" name="realname" value="${user.realname}">
                        <label>账号 <span class="muted">(用于登录系统)</span></label>
                        <input type="text" id="account" name="username" value="${user.username}">
                        ...
                        <div class="form-actions">
                            <button id="editBtn" class="button button-flat-action button-pill">保存</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    $(function(){
        ...
        $("#editForm").validate({
            ...
            submitHandler:function(form){
                $.post("/account/edit",$(form).serialize()).done(function(data){
